...
mongoPass = 'EiyZz4HUiuc8jHMG'
mongoUser = 'flutter'

client = pymongo.MongoClient(
    f"mongodb+srv://{mongoUser}:{{mongoPass}}@cluster0.g7iqr.mongodb.net/?retryWrites=true&w=majority"
)
db = client.test
